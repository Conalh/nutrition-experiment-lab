...
def test_seed_demo_creates_a_completed_experiment(client, conn, user_id):
    ...
    experiments = exp_svc.list_experiments(conn, user_id)
    ...
    detail = exp_svc.get_experiment_detail(conn, user_id, exp_id)
